...
function App() {
  ...
  const empleadoPagina = 5

  const indiceInicial = pagina * empleadoPagina;
  const indiceFinal = indiceInicial + empleadoPagina
  const filtro = empleados.slice(indiceInicial, indiceFinal)
  ...
  return (
    <div className="empleados">
      <div className='botonEmpleados'>
        ...
        {filtro.map((empleado) => 
          <div className='dataEmpleado'>
            <p>Nombre: {empleado.name} {empleado.lastName}</p>
            <p>Hobbies: {empleado.hobbies[0]}, {empleado.hobbies[1]}</p>
